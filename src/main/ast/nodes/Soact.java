...
public class Soact extends Node{
    ...
    public List<ActorDec> getActorDecs(){return this.actorDecs;};
    public List<RecordNode> getRecords(){return this.records;};
    public List<Statement> getMain(){return this.main;};

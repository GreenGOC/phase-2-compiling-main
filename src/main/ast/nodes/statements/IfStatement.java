...
public class IfStatement extends Statement{
    ...
    public List<Expression> getIfConds() {return ifConds;}
    public List<Statement> getIfBody(){return this.ifBody;}
    public List<List<Expression>> getElseIfConds(){return this.elseIfBlocksConds;}
    public List<List<Statement>> getElseIfBody(){return this.elseIfBlocksBody;}
    public List<Statement> getElseBody(){return this.elseBody;}
